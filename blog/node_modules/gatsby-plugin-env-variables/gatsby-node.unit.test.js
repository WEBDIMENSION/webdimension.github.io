...
describe("GatsbyNode", () => {
  describe("When using the old API configuration", () => {
    it("notifies the developer so they can update their gatsby-config", () => {
      ...
      }).toThrowError("Please update your gatsby-config and replace whitelist with allowList");
    });
  });
  describe("When using the new API configuration", () => {
    it("does not throw an error", () => {
      ...
      }).not.toThrowError("Please update your gatsby-config and replace whitelist with allowList");
    });
  });
});