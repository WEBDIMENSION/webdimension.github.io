export interface Typegen0 {
    ...
    eventsCausingActions: {
        ...
        reportEmitSchemaError: "error.platform.(machine).runningOnce.running.emitSchema.running:invocation[0]" | "error.platform.(machine).watching.jobs.emitSchema.running:invocation[0]";
        reportEmitPluginDocumentError: "error.platform.(machine).runningOnce.running.emitPluginDocument.running:invocation[0]";
        reportCodegenError: "error.platform.(machine).runningOnce.running.codegen.running:invocation[0]" | "error.platform.(machine).watching.jobs.codegen.running:invocation[0]";
        reportAutofixError: "error.platform.(machine).runningOnce.running.autofix.running:invocation[0]" | "error.platform.(machine).watching.jobs.autofix.running:invocation[0]";
    ...
    invokeSrcNameMap: {
        emitSchema: "done.invoke.(machine).runningOnce.running.emitSchema.running:invocation[0]" | "done.invoke.(machine).watching.jobs.emitSchema.running:invocation[0]";
        emitPluginDocument: "done.invoke.(machine).runningOnce.running.emitPluginDocument.running:invocation[0]";
        codegen: "done.invoke.(machine).runningOnce.running.codegen.running:invocation[0]" | "done.invoke.(machine).watching.jobs.codegen.running:invocation[0]";
        autofix: "done.invoke.(machine).runningOnce.running.autofix.running:invocation[0]" | "done.invoke.(machine).watching.jobs.autofix.running:invocation[0]";
    };
    missingImplementations: {
        actions: "reportEmitSchemaError" | "reportEmitPluginDocumentError" | "reportCodegenError" | "reportAutofixError";
    ...
    eventsCausingDelays: {};
    matchesStates: "initializing" | "runningOnce" | "runningOnce.running" | "runningOnce.running.emitSchema" | "runningOnce.running.emitSchema.running" | "runningOnce.running.emitSchema.done" | "runningOnce.running.emitPluginDocument" | "runningOnce.running.emitPluginDocument.running" | "runningOnce.running.emitPluginDocument.done" | "runningOnce.running.codegen" | "runningOnce.running.codegen.running" | "runningOnce.running.codegen.done" | "runningOnce.running.autofix" | "runningOnce.running.autofix.running" | "runningOnce.running.autofix.done" | "runningOnce.idle" | "watching" | "watching.schedulers" | "watching.jobs" | "watching.jobs.emitSchema" | "watching.jobs.emitSchema.idle" | "watching.jobs.emitSchema.running" | "watching.jobs.codegen" | "watching.jobs.codegen.idle" | "watching.jobs.codegen.running" | "watching.jobs.autofix" | "watching.jobs.autofix.idle" | "watching.jobs.autofix.running" | {
        runningOnce?: "running" | "idle" | {
            running?: "emitSchema" | "emitPluginDocument" | "codegen" | "autofix" | {
        ...
        watching?: "schedulers" | "jobs" | {
            jobs?: "emitSchema" | "codegen" | "autofix" | {
