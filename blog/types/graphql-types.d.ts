...
export type TagsQueryQuery = {
  site?:
    ...
    | undefined
  allMarkdownRemark: {
    group: Array<{ fieldValue?: string | null | undefined; totalCount: number }>
  }
}
...
export type Unnamed_2_Query = {
  ...
  tagsGroup: { group: Array<{ fieldValue?: string | null | undefined }> }
  categoriesGroup: { group: Array<{ fieldValue?: string | null | undefined }> }
}

export type NotFoundQueryQueryVariables = Exact<{ [key: string]: never }>

export type NotFoundQueryQuery = {
  site?:
    | {
        siteMetadata?: { title?: string | null | undefined } | null | undefined
      }
...
export type Unnamed_4_Query = {
  site?: { buildTime?: any | null | undefined } | null | undefined
}
