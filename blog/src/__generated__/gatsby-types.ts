declare namespace GatsbyTypes {
  ...
  type pageBlogsrcpagesusingTypescriptTsx2907560070QueryVariables = Exact<{
    [key: string]: never
  }>

  type pageBlogsrcpagesusingTypescriptTsx2907560070Query = {
      ...
      readonly nodes: ReadonlyArray<
        Pick<MarkdownRemark, "excerpt"> & {
          ...
          readonly frontmatter: Maybe<
            Pick<
              Frontmatter,
              "date" | "post_modified" | "title" | "description" | "tags"
            >
          >
        }
      >
  ...
  type blogListQueryQuery = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, "title" | "subTitle">>
    }>
    readonly allMarkdownRemark: {
      readonly nodes: ReadonlyArray<
        Pick<MarkdownRemark, "excerpt"> & {
  ...
  type BioDescriptionQuery = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<{
        readonly author: Maybe<Pick<Author, "name" | "summary">>
        readonly social: Maybe<Pick<Social, "twitter">>
        readonly github: Maybe<Pick<SiteSiteMetadataGithub, "repository">>
      }>
    }>
  }
  ...
  type BioQueryQuery = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<{
        readonly author: Maybe<Pick<Author, "name" | "summary">>
        readonly social: Maybe<Pick<Social, "twitter">>
        readonly github: Maybe<
          Pick<SiteSiteMetadataGithub, "url" | "repository">
        >
