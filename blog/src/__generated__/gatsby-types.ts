...
declare namespace GatsbyTypes {
  ...
  type FooterQuery = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, "title"> & { readonly author: Maybe<Pick<Author, "company">> }>
    }>
  }
  ...
  type BlogIndexQuery = {
    readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, "title">> }>
    readonly allMarkdownRemark: {
      readonly nodes: ReadonlyArray<Pick<MarkdownRemark, "excerpt"> & {
        readonly fields: Maybe<Pick<Fields, "slug">>
        readonly frontmatter: Maybe<Pick<Frontmatter, "date" | "post_modified" | "title" | "description" | "tags">>
      }>
    }
  }
  ...
  type BlogPostBySlugQuery = {
    readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, "title">> }>
    readonly markdownRemark: Maybe<Pick<MarkdownRemark, "id" | "excerpt" | "html"> & {
  ...
  type GatsbyImageSharpFixed_tracedSVGFragment = Pick<ImageSharpFixed,
    "tracedSVG" | "width" | "height" | "src" | "srcSet">

  type GatsbyImageSharpFixed_withWebpFragment = Pick<ImageSharpFixed,
    "base64" | "width" | "height" | "src" | "srcSet" | "srcWebp" | "srcSetWebp">

  type GatsbyImageSharpFixed_withWebp_tracedSVGFragment = Pick<ImageSharpFixed,
    "tracedSVG" | "width" | "height" | "src" | "srcSet" | "srcWebp" | "srcSetWebp">

  type GatsbyImageSharpFixed_noBase64Fragment = Pick<ImageSharpFixed, "width" | "height" | "src" | "srcSet">

  type GatsbyImageSharpFixed_withWebp_noBase64Fragment = Pick<ImageSharpFixed,
  ...
  type GatsbyImageSharpFluid_tracedSVGFragment = Pick<ImageSharpFluid,
    "tracedSVG" | "aspectRatio" | "src" | "srcSet" | "sizes">

  type GatsbyImageSharpFluid_withWebpFragment = Pick<ImageSharpFluid,
    "base64" | "aspectRatio" | "src" | "srcSet" | "srcWebp" | "srcSetWebp" | "sizes">

  type GatsbyImageSharpFluid_withWebp_tracedSVGFragment = Pick<ImageSharpFluid,
    "tracedSVG" | "aspectRatio" | "src" | "srcSet" | "srcWebp" | "srcSetWebp" | "sizes">

  type GatsbyImageSharpFluid_noBase64Fragment = Pick<ImageSharpFluid, "aspectRatio" | "src" | "srcSet" | "sizes">

  type GatsbyImageSharpFluid_withWebp_noBase64Fragment = Pick<ImageSharpFluid,
    "aspectRatio" | "src" | "srcSet" | "srcWebp" | "srcSetWebp" | "sizes">

  type staticBlogsrccomponentsseoTsx1188992244QueryVariables = Exact<{ [key: string]: never }>

  type staticBlogsrccomponentsseoTsx1188992244Query = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, "title" | "subTitle" | "description"> & {
  ...
  type blogListQueryQuery = {
    readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, "title" | "subTitle">> }>
    readonly allMarkdownRemark: {
      readonly nodes: ReadonlyArray<Pick<MarkdownRemark, "excerpt"> & {
        readonly fields: Maybe<Pick<Fields, "slug">>
        readonly frontmatter: Maybe<Pick<Frontmatter, "date" | "post_modified" | "title" | "description" | "tags">>
  ...
  type BioQueryQuery = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<{
        ...
        readonly social: Maybe<Pick<Social, "twitter">>
        readonly github: Maybe<Pick<SiteSiteMetadataGithub, "url" | "repository">>
        readonly dockerhub: Maybe<Pick<SiteSiteMetadataDockerhub, "url">>
      }>
    }>
  }
